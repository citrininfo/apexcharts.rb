    ...
    var A = {
        ...
        return r(t, [{
            ...
            key: "setYScaleForIndex", value: function (t, e, i) {
                ...
                var o = Math.abs(i - e);
                if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(e, i, r.logBase); else if (i !== -Number.MAX_VALUE && p.isNumber(i)) if (a.allSeriesCollapsed = !1, void 0 === r.min && void 0 === r.max || r.forceNiceScale) {
        ...
        return r(t, [{
            ...
            key: "predefined", value: function () {
                switch (this.w.config.theme.palette) {
                    case"palette1":
                        this.colors = ["#ac202f", "#36a832", "#323ca8", "#e05263", "#659157", "#5499c7"];
                        break;
                    case"palette2":
